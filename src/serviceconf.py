...
class Gui:
    ...
    def __init__(self):
        ...
        self.already_init = 0
        self.populateList ()
        self.toggled_service (0, 0, self.bgListServices)
        ...
        for s in (self.bgListServices, self.odListServices):
            for i in range (0, s.num_checkboxes):
                s.checkboxrenderer[i].connect ("toggled", self.toggled_service, s)
...
#-----------------------------------------------------------------------------
    def populateList (self):
        ...
        for servicename in self.bgServices:
            self.bgListServices.append_row (servicename, self.dict_bgServices[servicename][0])
        for servicename in self.odServices:
            self.odListServices.append_row (servicename, self.dict_odServices[servicename][0])
